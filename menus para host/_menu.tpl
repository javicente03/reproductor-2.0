    ...
    <div id="list">
        ...
        <div class="scroll">
            ...
            <section class="item-menu">
                <a class="header" href="{$base_url}/index.php?do=about"><i class="material-icons ipanel">layers</i>About</a>
                <hr>
            </section>

            <section class="item-menu">
                <a class="header" href="{$base_url}"><i class="material-icons ipanel">radio</i>Playlist</a>
                <hr>
            </section>
            ...
            <section class="item-menu">
                <a class="header" href="{$base_url}/index.php?do=contact"><i class="material-icons ipanel">album</i>Contacts</a>
                <hr>
            </section>
